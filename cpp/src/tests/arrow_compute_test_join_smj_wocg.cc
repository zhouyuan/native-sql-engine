...
TEST(TestArrowComputeMergeJoinWOCG, JoinTestUsingSemiJoinWithCondition) {
  ////////////////////// prepare expr_vector ///////////////////////
  auto table0_f0 = field("table0_f0", uint32());
  auto table0_f1 = field("table0_f1", uint32());
  auto table0_f2 = field("table0_f2", uint32());
...
TEST(TestArrowComputeMergeJoinWOCG, JoinTestUsingInnerJoinWithCondition) {
  ////////////////////// prepare expr_vector ///////////////////////
  auto table0_f0 = field("table0_f0", uint32());
  auto table0_f1 = field("table0_f1", uint32());
  auto table0_f2 = field("table0_f2", uint32());
...
TEST(TestArrowComputeMergeJoinWOCG, JoinTestWithTwoKeysUsingInnerJoin) {
  ////////////////////// prepare expr_vector ///////////////////////
...
TEST(TestArrowComputeMergeJoinWOCG, JoinTestUsingAntiJoinWithCondition) {
  ////////////////////// prepare expr_vector ///////////////////////
  auto table0_f0 = field("table0_f0", uint32());
  auto table0_f1 = field("table0_f1", uint32());
  auto table0_f2 = field("table0_f2", uint32());
